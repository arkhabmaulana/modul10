...
public static void main (String args []) {
    ...
    JOptionPane.showMessageDialog(null,"Selamat Datang\n Anjungan "
            ...
            try{
                do{
                    str = JOptionPane.showInputDialog(null, "Masukkan "
                            + "4 Digit PIN Anda:",
                                                                                    ...
                                                                                    switch (choice){
                                                                                        case 1:
                                                                                            JOptionPane.showMessageDialog(null, "Saldo Anda saat ini"
                                                                                                    + "sebesar : " + tab); //informasi saldo
                                                                                            
                                                                                            z=JOptionPane.showConfirmDialog(null,"Melanjutkan"
                                                                                                    + "transaksi lain?","ATM BNI SYARIAH-BOJONEGORO",
                                                                                        ...
                                                                                        case 2:
                                                                                        str1 = JOptionPane.showInputDialog(null,"Masukkan"
                                                                                                + "jumlah penyetoran: "); //menabung
                                                                                        ...
                                                                                        tab =hasil.getsaldo();
                                                                                                ...
                                                                                                if (z==0)
                                                                                                    ...
                                                                                                    JOptionPane.showMessageDialog(null,"Terimakasih telah"
                                                                                                            + "menggunakan ATM BRI, ambil kartu ATM  Anda.");
                                                                                                            System.exit(0);
                                                                                                            
                                                                                        case 3:
                                                                                            str1 = JOptionPane.showInputDialog(null,"Masukkan"
                                                                                                    + "jumlah penarikan : "); //pengambilan
                                                                                                                ...
                                                                                                                z=JOptionPane.showConfirmDialog(null,"Melanjutkan"
                                                                                                                        + "transaksi lain?","ATM BN SYARIAH-BOJONEGORO",
                                                                                                                        JOptionPane.YES_NO_OPTION, 3); //konfirmasi transaksi lain
                                                                                        ...
                                                                                        case 5:
                                                                                            z=JOptionPane.showConfirmDialog(null,"Anda ingin"
                                                                                                    + "keluar?","Keluar", JOptionPane.YES_NO_OPTION, 0);
                            ...
                            {
                                JOptionPane.showMessageDialog(null,"Untuk bantuan"
                ...
                while (1==1);
                    ...
                    JOptionPane.showMessageDialog(null,"Kesalahan !\nPastikan"
                            + "kode yang anda masukkan berformat benar! \n PROGRAM KELUAR!"
                            + "\nTerimakasih","ERROR",0);
